              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <option value="prenatal">Xét nghiệm tiền hôn nhân</option>
                    <option value="pregnancy">Xét nghiệm tiền sản</option>
                  </select>
                </div>
              ...
              <CardContent className="p-0">
                <div className="aspect-square bg-gray-200 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500 text-sm">Bản đồ vị trí</p>
                    <p className="text-gray-400 text-xs">123 Đường ABC, Quận 1, TP.HCM</p>
                  </div>
                </div>
              </CardContent>
            </Card>
